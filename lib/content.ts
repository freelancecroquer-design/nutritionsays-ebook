export const ebookContent = {
    ...
    sections: [
        {
            id: "intro",
            title: "Introducción: La nutrición no es magia, es acompañamiento",
            ...
            icon: "Sparkles",
            image: "/images/arianna-yoga-smile.jpg",
            imageAlt: "Arianna García Wellness",
            imagePosition: "right"
        },
        {
            id: "nutricion-real",
            title: "Qué es realmente la nutrición (y qué no es)",
            ...
            content: [
                ...
                "La nutrición no se trata solo de bajar de peso.",
                "También se trata de:",
                "• Prevenir y tratar enfermedades.",
                "• Mejorar tu relación con la comida.",
                "• Promover tu bienestar físico y mental.",
            ...
            icon: "Scale",
            image: "/images/arianna-plate-smile.jpg",
        ...
        },
        {
            ...
            subtitle: "Tu dieta es todo lo que comes en un día",
            content: [
                ...
                "Existen contextos, cantidades y frecuencias.",
                "Un dulce no te enferma, así como una ensalada no te cura.",
            ...
            icon: "Utensils",
            image: "/images/arianna-market-blazer.jpg",
            imageAlt: "Arianna en el mercado",
            imagePosition: "left"
        },
        {
            id: "consulta",
            title: "Qué puede esperar un paciente de su consulta nutricional",
            subtitle: "Más que un plan de alimentación",
            content: [
                ...
                "• Evaluación clínica y alimentaria completa.",
                "• Escucha activa y contextualización.",
                "• Definición de objetivos sostenibles.",
                "• Diseño de plan alimentario individualizado.",
            ...
            icon: "Stethoscope",
            image: "/images/arianna-plate-offer.jpg",
        ...
        },
        {
            ...
            subtitle: "Los 3 Pilares Fundamentales",
            content: [
                ...
                "1. La saciedad: No es llenarse, es sentirse satisfecho. Es el punto donde tu cuerpo te dice “es suficiente”, sin culpa ni exceso. Aprender a reconocer la saciedad es un ejercicio de conexión interna.",
                "2. El equilibrio: No es comer perfecto. Es mantener una relación coherente con la comida, donde hay espacio para lo nutritivo y también para lo disfrutable. El cuerpo no necesita rigidez, necesita constancia y coherencia.",
                ...
                "La nutrición personalizada respeta tu historia, tus preferencias y tu entorno.",
                "Por eso, la meta no es seguir una dieta, sino aprender a crear tu propio equilibrio."
            ],
            icon: "Activity",
            image: "/images/arianna-yoga-meditate.jpg",
            imageAlt: "Arianna Meditando",
            imagePosition: "right"
        },
        {
            id: "movimiento",
            title: "Movimiento: tu cuerpo fue hecho para vivir, no para castigarse",
            subtitle: "El movimiento es celebración",
            content: [
                ...
                "El ejercicio no tiene que ser extremo ni doloroso.",
                "No necesitas pasar horas en el gimnasio ni seguir rutinas imposibles para mantenerte activo.",
                "La clave está en encontrar el movimiento que disfrutes: caminar, bailar, nadar, subir escaleras, pasear a tu mascota, jugar con tus hijos, limpiar tu casa con música.",
                "Todo suma.",
                "Eso también es actividad física cotidiana (NEAT): todos esos movimientos pequeños que hacemos fuera del ejercicio formal y que, sumados, impactan de manera positiva en nuestra salud.",
        ...
        },
        {
            ...
            content: [
                ...
                "Es darte permiso para aprender, equivocarte y ajustar.",
                ...
                "@nutritionsays existe para recordarte que no necesitas una dieta para cambiar tu vida.",
                "Necesitas información clara, acompañamiento profesional y un espacio seguro para transformar tus hábitos desde la consciencia.",
                ...
                "Gracias por leer. Que este ebook sea el inicio de un camino más amable y consciente con tu cuerpo, tu mente y tu relación con la comida.",
                "@nutritionsays — La nutrición no empieza en el plato, empieza en ti."
            ],
            icon: "Heart",
            image: "/images/arianna-plate-smile.jpg",
            imageAlt: "Arianna Final",
            imagePosition: "right"
        },
        {
